    ...
    public function handle(Request $request, Closure $next): Response
    {
        if ($request->route('id')) {
            ...
            if (!Profile::authorize(InterfaceClass::RETURN_LIST)) {
             ...
             (int) $countRetHeader = ReturnHeader::where('id', $request->route('id'))->count();
