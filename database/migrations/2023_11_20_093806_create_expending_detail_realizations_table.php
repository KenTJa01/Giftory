...
return new class extends Migration
{
    ...
    {
        Schema::create('expending_detail_realizations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('req_id');
            $table->foreign("req_id")->references("id")->on("transfer_headers");
            ...
            $table->unique(['req_id', 'catg_id', 'from_location_id']);
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('expending_detail_realizations');
    }
};
